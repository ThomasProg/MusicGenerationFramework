...
def load_transformed_dataset():
    ...
    # train = torchvision.datasets.MNIST(root="./data", train=True, download=True, transform=data_transform)
    # test = torchvision.datasets.MNIST(root="./data", train=False, download=True, transform=data_transform)
...
save_dir = "./Assets/Models/flower101_diffusion_model"  # Directory to save the models

...
if (loadFromDisk):
    model = AutoModelForCausalLM.from_pretrained("MIDICausalFinetuningFromFolder/")
else:
...
training_args = TrainingArguments(
    output_dir="MIDICausalFinetuningFromFolder",
    eval_strategy="epoch",
    learning_rate=2e-5,
    weight_decay=0.01,
    push_to_hub=True,
...
trainer.push_to_hub("MIDICausalFinetuningFromFolder")

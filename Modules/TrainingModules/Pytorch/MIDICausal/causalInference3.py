...
outputs = model.generate(inputs2, logits_processor=LogitsProcessorList([CustomLogitsProcessor()]), max_new_tokens=1024//2//2-1, do_sample=True, top_k=50, top_p=0.95, pad_token_id=2000)
